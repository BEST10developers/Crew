...
precedencegroup ConstraintPriorityPrecedence { higherThan : AdditionPrecedence }
precedencegroup ConstraintAdditionPrecedence { higherThan : ConstraintPriorityPrecedence }
infix operator ! : ConstraintPriorityPrecedence
infix operator ~ : ConstraintAdditionPrecedence
...
public func ==(lhs: View, rhs: (View, EdgeInsets)) -> () -> [NSLayoutConstraint] {
    return build(lhs: lhs, rhs: rhs.0, insets: rhs.1, relations: (.equal, .equal, .equal, .equal))
}

public func >=(lhs: View, rhs: (View, EdgeInsets)) -> () -> [NSLayoutConstraint] {
    return build(lhs: lhs, rhs: rhs.0, insets: rhs.1, relations: (.lessThanOrEqual, .lessThanOrEqual, .greaterThanOrEqual, .greaterThanOrEqual))
}

public func <=(lhs: View, rhs: (View, EdgeInsets)) -> () -> [NSLayoutConstraint] {
    return build(lhs: lhs, rhs: rhs.0, insets: rhs.1, relations: (.greaterThanOrEqual, .greaterThanOrEqual, .lessThanOrEqual, .lessThanOrEqual))
}
